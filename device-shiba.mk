...
TARGET_KERNEL_DIR := pixel_kernel/shusky
TARGET_BOARD_KERNEL_HEADERS := pixel_kernel/shusky/kernel-headers
TARGET_PREBUILT_KERNEL := pixel_kernel/shusky/Image.lz4
